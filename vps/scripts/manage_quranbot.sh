...
alias qb-dashboard-monitor=bash /opt/DiscordBots/QuranBot/vps/scripts/manage_quranbot.sh dashboard-monitor
alias qb-dashboard-monitor-stop=bash /opt/DiscordBots/QuranBot/vps/scripts/manage_quranbot.sh dashboard-monitor-stop
alias qb-dashboard-monitor-restart=bash /opt/DiscordBots/QuranBot/vps/scripts/manage_quranbot.sh dashboard-monitor-restart
alias qb-dashboard-monitor-status=bash /opt/DiscordBots/QuranBot/vps/scripts/manage_quranbot.sh dashboard-monitor-status
alias qb-dashboard-monitor-logs=bash /opt/DiscordBots/QuranBot/vps/scripts/manage_quranbot.sh dashboard-monitor-logs
...
EOF
    ...
    log_info "Dashboard Monitoring:"
    log_info "  qb-dashboard-monitor         - Start dashboard monitor"
    log_info "  qb-dashboard-monitor-stop    - Stop dashboard monitor"
    log_info "  qb-dashboard-monitor-restart - Restart dashboard monitor"
    log_info "  qb-dashboard-monitor-status  - Show dashboard monitor status"
    log_info "  qb-dashboard-monitor-logs    - Show dashboard monitor logs"
...
main() {
    case "${1:-}" in
        ...
        "dashboard-monitor")
            check_root
            systemctl start quranbot-dashboard-monitor
            log_success "Dashboard monitor started"
            ;;
        "dashboard-monitor-stop")
            check_root
            systemctl stop quranbot-dashboard-monitor
            log_success "Dashboard monitor stopped"
            ;;
        "dashboard-monitor-restart")
            check_root
            systemctl restart quranbot-dashboard-monitor
            log_success "Dashboard monitor restarted"
            ;;
        "dashboard-monitor-status")
            systemctl status quranbot-dashboard-monitor --no-pager
            ;;
        "dashboard-monitor-logs")
            journalctl -u quranbot-dashboard-monitor -n ${2:-50} --no-pager
            ;;
        "sync-logs")
            sync_logs_to_local
            ;;
        ...
        "aliases")
            check_root
            echo "  dashboard-monitor           Start dashboard monitor"
            echo "  dashboard-monitor-stop      Stop dashboard monitor"
            echo "  dashboard-monitor-restart   Restart dashboard monitor"
            echo "  dashboard-monitor-status    Show dashboard monitor status"
            echo "  dashboard-monitor-logs      Show dashboard monitor logs"
            create_aliases
            ;;
        "help"|"-h"|"--help")
