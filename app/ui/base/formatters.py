...
def format_time_elapsed(
    start_time: datetime, current_time: datetime | None = None
) -> str:
    """
...
def format_activity_display(
    user: dict[str, Any], action: str, timestamp: datetime
) -> str:
    """
...
def format_surah_display(
    surah_info: dict[str, Any], include_verses: bool = True
) -> str:
    """
...
def format_list_display(
    items: list[str], max_items: int = 5, separator: str = " • "
) -> str:
    """
