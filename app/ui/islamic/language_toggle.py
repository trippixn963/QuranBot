...
class LanguageToggleView(discord.ui.View):
    ...
    def __init__(self, english_response: str, arabic_response: str, original_question: str, 
                 user: discord.User, remaining_questions: int = 1, bot=None):
    ...
    async def switch_to_arabic(self, interaction: discord.Interaction):
        ...
        try:
            ...
            TreeLogger.debug("Switched to Arabic", {
    ...
    async def switch_to_english(self, interaction: discord.Interaction):
        ...
        try:
            ...
            TreeLogger.debug("Switched to English", {
                "user_id": interaction.user.id
            })
