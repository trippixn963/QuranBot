...
class IslamicCalendarService:
    ...
    def _load_islamic_events(self):
        ...
        try:
            if self.islamic_events_file.exists():
                with open(self.islamic_events_file, encoding='utf-8') as f:
    ...
    async def get_current_hijri_date(self) -> dict[str, Any] | None:
    ...
    def _get_special_occasion(self, month: int, day: int) -> str | None:
...
# Global instance
islamic_calendar_service: IslamicCalendarService | None = None
