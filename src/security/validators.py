...
class SecureValidator:
    ...
    @classmethod
    def validate_surah_number(cls, surah: Union[str, int]) -> int:
    ...
    @classmethod
    def validate_text_input(cls, text: str, max_length: int = 1000, 
    ...
    def sanitize_log_data(cls, data: dict) -> dict:
        ...
        sensitive_keys = {
            'token', 'password', 'secret', 'key', 'auth', 'api_key',
            'discord_token', 'openai_api_key', 'webhook_url', 'private'
        }
