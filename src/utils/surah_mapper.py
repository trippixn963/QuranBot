...
def get_surah_emoji(surah_number: int) -> str:
    ...
    emoji_mapping = {
        ...
        43: "✨",    # Az-Zukhruf - The Ornaments
        44: "💨",    # Ad-Dukhan - The Smoke
        45: "🛐",    # Al-Jathiyah - The Kneeling
        46: "🏔️",    # Al-Ahqaf - The Dunes
        ...
        58: "👩‍⚖️",   # Al-Mujadilah - The Pleading Woman
        59: "🏃‍♂️",   # Al-Hashr - The Exile
        60: "👩‍⚖️",   # Al-Mumtahanah - The Woman to be Examined
        61: "📏",    # As-Saf - The Ranks
        62: "🕌",    # Al-Jumu'ah - The Congregation
        63: "😔",    # Al-Munafiqun - The Hypocrites
        64: "⚖️",    # At-Taghabun - The Mutual Disillusion
        65: "💔",    # At-Talaq - Divorce
        ...
        79: "🌪️",    # An-Nazi'at - Those Who Drag Forth
        80: "😤",    # Abasa - He Frowned
    ...
    return emoji_mapping.get(surah_number, "📖")  # Default to book emoji
