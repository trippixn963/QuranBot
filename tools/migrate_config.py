...
def migrate_configuration():
    ...
    for key in required_settings:
        ...
        if old_key in old_config:
            ...
            new_config_lines.append(f"# {key}=YOUR_VALUE_HERE  # ⚠️ REQUIRED - Please set this!")
    ...
    # Optional Discord settings
    optional_discord = ['PANEL_CHANNEL_ID', 'LOGS_CHANNEL_ID', 'DAILY_VERSE_CHANNEL_ID', 'PANEL_ACCESS_ROLE_ID']
    ...
    # Audio settings
    audio_settings = ['AUDIO_FOLDER', 'DEFAULT_RECITER', 'FFMPEG_PATH', 'AUDIO_QUALITY', 'DEFAULT_SHUFFLE', 'DEFAULT_LOOP']
    ...
    perf_settings = ['RATE_LIMIT_PER_MINUTE', 'MAX_CONCURRENT_AUDIO', 'BACKUP_INTERVAL_HOURS']
    ...
    print("2. Update your imports to use: from src.config.unified_config import get_config")
